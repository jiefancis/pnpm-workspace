...
export default function useModal(props: any, { emit }: SetupContext) {
  ...
  function drag(oDrag: any, handle: any) {
    ...
    handle.onmousedown = function (event: MouseEvent) {
    ...
    revertRef.value.onclick = function () {
      ...
      oDrag.style.width = 'unset'
      oDrag.style.height = 'unset'
  ...
  function resize(oParent: any, handle: any, isLeft: boolean, isTop: boolean, lockX: any, lockY: any) {
    handle.onmousedown = function (event: MouseEvent) {
